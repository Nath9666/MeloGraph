...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div ref={carouselRef} className="yoverflow-hidden">
      <div
        ref={ref}
        className={cn(
          "yflex",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ? "y-left-12 ytop-1/2 y-translate-y-1/2"
          : "y-top-12 yleft-1/2 y-translate-x-1/2 yrotate-90",
        className
      )}
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        orientation === "horizontal"
          ? "y-right-12 ytop-1/2 y-translate-y-1/2"
          : "y-bottom-12 yleft-1/2 y-translate-x-1/2 yrotate-90",
        className
      )}
      ...
      {...props}
    >
      <ArrowRight className="yh-4 yw-4" />
